...
![](https://github.com/nessakiani/twitter_postgres_parallel/workflows/tests_normalized/badge.svg)

![](https://github.com/nessakiani/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg)

![](https://github.com/nessakiani/twitter_postgres_parallel/workflows/tests_normalized_batch/badge.svg)

![](https://github.com/nessakiani/twitter_postgres_parallel/workflows/tests_normalized_batch_parallel/badge.svg)

![](https://github.com/nessakiani/twitter_postgres_parallel/workflows/tests_denormalized/badge.svg)

![](https://github.com/nessakiani/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg)
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 7m58.34s                  | 0m57.42s                  | 
| `pg_normalized_batch`  | 2m46.97s                  | 0m14.74s                  | 
| `pg_denormalized`      | 0m9.89s                   | 0m4.14s                   | 
